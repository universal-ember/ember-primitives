...
<template>
  <button onclick={{useBootstrap.toggle}} type="button" class="btn btn-primary">Toggle Bootstrap</button>
  &nbsp;
  <button onclick={{useBootstrap.toggle}} type="button" class="btn btn-success">Toogle Bootstrap</button>
