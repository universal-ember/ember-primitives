...
<details open><summary><h3>Materialize</h3></summary>

See: [Materialize Switch](https://materializecss.com/switches.html) docs.

NOTE: materialize does not have focus styles.
...
<template>
  ...
  <style>
    ...
    * {box-sizing: border-box;}
    ...
    .sr-only { text-indent: -9999px; height: 1px; width: 1px; overflow: hidden; }
