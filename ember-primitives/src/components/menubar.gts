 ...
 *
 * A menubar is a horizontal collection of menus that are typically used for
...
const TABSTER_CONFIG_MENUBAR = getTabsterAttribute(
  {
    mover: {
...
class MenubarMenu extends Component<MenuSignature> {
