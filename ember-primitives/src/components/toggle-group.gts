...
export interface SingleSignature<Value = any> {
...
export class ToggleGroup<Value = any> extends Component<
  SingleSignature<Value> | MultiSignature<Value>
> {
...
class MultiToggleGroup<Value = any> extends Component<{
  Element: MultiSignature<Value>['Element'];
  Args: Omit<MultiSignature<Value>['Args'], 'type'>;
  Blocks: MultiSignature<Value>['Blocks'];
}> {
  /**
